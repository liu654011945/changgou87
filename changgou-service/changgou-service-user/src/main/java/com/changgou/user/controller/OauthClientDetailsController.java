...
public class OauthClientDetailsController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  OauthClientDetails oauthClientDetails, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  OauthClientDetails oauthClientDetails,@PathVariable(name="id") String id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<OauthClientDetails> findById(@PathVariable(name="id") String id){
