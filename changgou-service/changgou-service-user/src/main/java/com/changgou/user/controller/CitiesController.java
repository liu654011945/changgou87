...
public class CitiesController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  Cities cities, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Cities cities,@PathVariable(name="id") String id){
        //设置主键值
        cities.setCityid(id);
     ...
     */
    @GetMapping("/{id}")
    public Result<Cities> findById(@PathVariable(name="id") String id){
