...
public class AreasController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  Areas areas, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Areas areas,@PathVariable(name="id") String id){
        //设置主键值
        areas.setAreaid(id);
     ...
     */
    @GetMapping("/{id}")
    public Result<Areas> findById(@PathVariable(name="id") String id){
