...
public class ProvincesController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  Provinces provinces, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Provinces provinces,@PathVariable(name="id") String id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<Provinces> findById(@PathVariable(name="id") String id){
