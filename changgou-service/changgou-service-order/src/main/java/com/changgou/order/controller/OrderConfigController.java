...
public class OrderConfigController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  OrderConfig orderConfig, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  OrderConfig orderConfig,@PathVariable(name="id") Integer id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<OrderConfig> findById(@PathVariable(name="id") Integer id){
