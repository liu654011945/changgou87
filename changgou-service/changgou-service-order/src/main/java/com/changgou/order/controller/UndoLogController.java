...
public class UndoLogController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  UndoLog undoLog, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  UndoLog undoLog,@PathVariable(name="id") Long id){
        //设置主键值
        undoLog.setId(id);
     ...
     */
    @GetMapping("/{id}")
    public Result<UndoLog> findById(@PathVariable(name="id") Long id){
