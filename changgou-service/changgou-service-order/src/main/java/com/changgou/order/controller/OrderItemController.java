...
public class OrderItemController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  OrderItem orderItem, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  OrderItem orderItem,@PathVariable(name="id") String id){
        //设置主键值
        orderItem.setId(id);
     ...
     */
    @GetMapping("/{id}")
    public Result<OrderItem> findById(@PathVariable(name="id") String id){
