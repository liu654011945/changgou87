...
public class OrderLogController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  OrderLog orderLog, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @GetMapping("/{id}")
    public Result<OrderLog> findById(@PathVariable(name="id") String id){
