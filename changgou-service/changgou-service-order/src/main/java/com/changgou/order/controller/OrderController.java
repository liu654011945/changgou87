...
public class OrderController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  Order order, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  Order order,@PathVariable(name="id") String id){
        //设置主键值
        order.setId(id);
    ...
    public Result add(@RequestBody   Order order){
        ...
        order.setUsername(username);//订单所属的用户
     ...
     */
    @GetMapping("/{id}")
    public Result<Order> findById(@PathVariable(name="id") String id){
