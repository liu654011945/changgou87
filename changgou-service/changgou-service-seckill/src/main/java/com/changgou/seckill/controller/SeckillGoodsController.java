...
public class SeckillGoodsController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false) SeckillGoods seckillGoods, @PathVariable(name="page")  int page, @PathVariable(name="page")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody SeckillGoods seckillGoods, @PathVariable(name="id") Long id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<SeckillGoods> findById(@PathVariable(name="id") Long id){
